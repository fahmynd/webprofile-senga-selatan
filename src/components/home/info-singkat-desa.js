                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="vertical-center" style={{ textAlign: 'justify' }}>
                            ...
                            <span className="info-singkat-desa__nama fw-bold center-v text-light">Desa <span id="#namaDesa">Senga Selatan</span></span>
                            <p className="mt-3 p-2 text-light rounded">
                            ...
                            <p className='p-2 text-light rounded'>
