...
function BerbagiMomen() {
    return (
        <section id="berbagiMomen">
                    ...
                    <div className="col-md-12">
                        <div className="grid-gallery">
                            <div className="item-gallery">
                                <img src="https://picsum.photos/200/400?random=3" alt="" />
                            </div>
                            <div className="item-gallery">
                            ...
                            <div className="item-gallery">
                                <img src="https://picsum.photos/200/500?random=3" alt="" />
                            </div>
                            <div className="item-gallery">
                                <img src="https://picsum.photos/300/500?random=3" alt="" />
                            </div>
                            <div className="item-gallery">
