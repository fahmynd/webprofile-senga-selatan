...
function Jumbotron() {
    return (
        <>
            {/* <header className="d-lg-none welcome-mobile-section rel-container" style={{ minHeight: '195px' }}>
                <div id="backgroundImg" className="background-image-div d-lg-none"></div>
                <div className="row">
                    <div className="col-12 text-center">
                        <p className="font-welcome font-welcome-mobile welcome">Selamat Datang</p>
                        <h1 className="font-welcome font-welcome-mobile">Website </h1>
                    </div>
                </div>
            </header>
            <header style={{ background: 'url()', backgroundSize: 'cover' }} id="backgroundImg" className="background-image-div d-none d-lg-block">
            </header> */}
                    ...
                    <div className="row">
                        <div className="col-md-5 clr-white fs-6">
                            <div className="vertical-center" style={{ textAlign: 'justify' }}>
                                ...
                                <ShowMoreText anchorClassName='link-selengkapnya' lines={5} more="Selengkapnya" less="Sembunyikan">
                                    <p>
