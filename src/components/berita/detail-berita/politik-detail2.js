...
export default function PolitikBerita2() {
    useEffect(function () {
        document.title = "Pemdes Senga Selatan Gelar Musdes II, Pembahasan RKPDesa Berbasis SGDs Desa Tahun 2023 | Website Profil Desa Senga Selatan";
    }, []);
    return (
            ...
            <div className="konten" itemScope itemType="http://schema.org/Blog">
                <div className="row mt-5">
                    ...
                    <div className="col-md-12 mt-2 text-center">
                        <img className="img-content" src={politikBerita2} width="70%" alt="Foto Berita" />
                    </div>
                </div>
